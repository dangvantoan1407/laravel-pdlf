                        ...
                        <table>
                            ...
                            <tr>
                                <td class="shoping__cart__item">
                                    <img src="{{$item->thumbnail}}" width="20%" alt="">
                                    <h5></h5>
                                </td>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="shoping__checkout">
                        ...
                        <a href="{{url("/check_out")}}" class="primary-btn btn  @if(!$can_checkout)disabled @endif">PROCEED TO CHECKOUT</a>
                    </div>
                </div>
            </div>
        </div>
