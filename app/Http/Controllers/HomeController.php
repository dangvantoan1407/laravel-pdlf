...
//        $category = Category::findOrFail($id);
    ...
    public function product(Product $product){
             $relateds = Product::where("category_id",$product->category_id)
                 ...
                 ->limit(4)
                 ->get();
        return view("pages.shop-detail",compact("product","relateds"));
    }
    ...
    public function cart(){
        ...
        return view("pages.shopping-cart",compact("cart","subtotal","total","can_checkout"));
    }
    ...
    public function checkout(){
        ...
        return view("pages.check_out",compact("cart","subtotal","total"));
